...
@section("app")
    <div class="flex flex-col flex-grow justify-center items-center pb-20">
        ...
        <a href="{{ route("login") }}" class="py-5 px-10 bg-gradient-to-br from-blue-400 to-green-500 rounded-xl shadow flex flex-row items-center hover:from-blue-300 to-green-400">
